...
export class Controller {
    ...
    constructor(
        ...
        // floorManager: TileMap // for debug purpose only!
        ) {
        this.app = engine.app;
        ...
        // this.floorManager = floorManager; // for debug purpose only!
    ...
    private update(dt: number): void {
        ...
        // this.printCameraPosition(); // for debug purpose only!

        this.checkTileBoundary();
        // this.checkFloorBoundary(); // for debug purpose only!
    }
